...
|---------------------|------------------------------------------------------------------------------------|-------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------|
| **Example:**        | [![Class Diagram](/images/archDiagA/umlClass.svg)](/images/archDiagA/umlClass.svg) | [![SVG Example](/images/output.svg)](/images/output.svg)                | ![SVG Example](/images/output.svg)                                                                                               | ![SVG Example](/images/output.svg)                                           |
...
| **Concerns:**       | Domain Models / Data Models / Logical Architecture / Implementation Classes        | Namespacing, Dependencies, Packages for each App Tier                   | The Interfaces that each Component Provides and Requires, Loose Coupling                                                         | Either Generic Operational Requirements or Specific Cases                    |
